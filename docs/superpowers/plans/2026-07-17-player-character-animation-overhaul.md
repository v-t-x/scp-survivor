...
- 角色是成年男性基金会异常响应干员(**2026-07-23 修订**：项目所有者在 Gate 1 验收期间直接决定由成年女性调整为成年男性；本计划全文中所有 “成年女性”/“adult female” 字样(含 Task 3/5/6 内嵌 prompt)均被该决定取代为 “成年男性”/“adult male”,Gate 1 已生成的女性候选全部标记为因方向调整被拒并仅保留审计记录)；精细像素风；允许适度二次元化，但不得使用校服、偶像、泳装、夸张身体比例或 Q 版大头。
